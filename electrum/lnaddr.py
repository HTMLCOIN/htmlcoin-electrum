...
def encode_fallback(fallback, currency):
    ...
    """
    if currency in [constants.HtmlcoinMainnet.SEGWIT_HRP, constants.HtmlcoinTestnet.SEGWIT_HRP]:
...
base58_prefix_map = {
    constants.HtmlcoinMainnet.SEGWIT_HRP : (constants.HtmlcoinMainnet.ADDRTYPE_P2PKH, constants.HtmlcoinMainnet.ADDRTYPE_P2SH),
    constants.HtmlcoinTestnet.SEGWIT_HRP : (constants.HtmlcoinTestnet.ADDRTYPE_P2PKH, constants.HtmlcoinTestnet.ADDRTYPE_P2SH)
}
