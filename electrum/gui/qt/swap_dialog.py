...
class SwapDialog(WindowModalDialog):
    ...
    def update(self):
        ...
        self.send_button.setIcon(read_QIcon("lightning.png" if self.is_reverse else "htmlcoin.png"))
        self.send_button.repaint()  # macOS hack for #6269
        self.recv_button.setIcon(read_QIcon("lightning.png" if not self.is_reverse else "htmlcoin.png"))
