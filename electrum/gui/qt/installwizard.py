...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: QApplication, plugins: 'Plugins', *, gui_object: 'ElectrumGui'):
        ...
        self.setWindowTitle('Htmlcoin Electrum  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('Htmlcoin Electrum wallet'))
    ...
    def restore_seed_dialog(self, run_next, test):
        ...
        if 'mobile' == self.wallet_type:
            message = ''.join([
                ...
                _('This is compatible with htmlcoin mobile wallet. \n')])
        else:
            if self.opt_ext:
                options.append('ext')
